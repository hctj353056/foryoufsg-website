...
parse_txt_to_json(os.path.join(BASE, "poetry", "原创古诗词.txt"), os.path.join(BASE, "poetry", "诗词.json"))
parse_txt_to_json(os.path.join(BASE, "articles", "原创散文.txt"), os.path.join(BASE, "articles", "散文.json"))
